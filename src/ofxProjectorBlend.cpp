                              ...
                              ofxProjectorBlendRotation _rotation)
{
    ...
    ofLogNotice("ofxProjectorBlend::setup") << "res: " << resolutionWidth << " x " << \
    (resolutionWidth * _numProjectors) << " overlap: " << _pixelOverlap << " layout: " << _layout << " overlap: " << _pixelOverlap;
    ...
    if (numProjectors <= 0)
    {
        ofLogError("ofxProjectorBlend::setup") << "Cannot initialize with " << this->numProjectors << " projectors.";
        return;
    }
    ...
    {
        ofLogError("ofxProjectorBlend") << "You have used an invalid ofxProjectorBlendLayout.";
        return;
    }
