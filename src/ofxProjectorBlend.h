...
protected:
    ...
    float fullTextureWidth = 0.0f;
    float fullTextureHeight = 0.0f;
    float singleChannelWidth = 0.0f;
    float singleChannelHeight = 0.0f;

    float displayWidth = 0.0f;
    float displayHeight = 0.0f;

    float pixelOverlap = 0.0f;
    int numProjectors = 0;
